...
#define SERVO_MIDDLE 680
#define SERVO_DIFF 320.0
#define SERVO_MIN 360
...
#define MOTOR  ATOM1_CH1_P33_9
#define MOTOR1 ATOM1_CH2_P33_11
#define MOTOR2 ATOM3_CH4_P33_12
#define MOTOR3 ATOM3_CH5_P33_13



#define SERVO ATOM0_CH5_P00_6
#define SERVO1 ATOM0_CH6_P00_7

#endif



#define motor_init gtm_pwm_init(MOTOR, MOTOR_FREQUENCY, 0)//左正
#define motor1_init gtm_pwm_init(MOTOR1, MOTOR_FREQUENCY, 0)//左反
#define motor2_init gtm_pwm_init(MOTOR2, MOTOR_FREQUENCY, 0)//右反
#define motor3_init gtm_pwm_init(MOTOR3, MOTOR_FREQUENCY,0)//右正



#define steer_init gtm_pwm_init(SERVO, SERVO_FREQUENCY, 680)
#define steer1_init gtm_pwm_init(SERVO1, SERVO_FREQUENCY, 680)
...
#define motor2(a)  pwm_duty(MOTOR2, a)
#define motor3(a)  pwm_duty(MOTOR3, a)
