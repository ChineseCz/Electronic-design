...
void seekfree_wireless_init(void)
{
    ...
    uart_init (WIRELESS_UART1, WIRELESS_UART1_BAUD, WIRELESS_UART1_TX, WIRELESS_UART1_RX);
    uart_init (WIRELESS_UART2, WIRELESS_UART2_BAUD, WIRELESS_UART2_TX, WIRELESS_UART2_RX);
