...
void if_put_drug()
{
    if (flag.reed&& !flag.first_get_reed )
    {
        flag.drug=1;
        flag.first_get_reed=1;
        flag.str=1;
    }
}
void if_get_drug()
{
    if (!flag.reed && flag.drug==2 && !flag.first_out_reed)
    {
        flag.drug=3;
        flag.first_out_reed=1;
        flag.led=0;
...
//	            reeds_get();
//	            if_put_drug();
//	            if ( !cnt.right && !cnt.left&&  flag.drug==1 && mv.track==0)
//	            {
//	                flag.drug=2;
//	                flag.led=1;
//	            }
//	            if_get_drug();
//                if (!cnt.right && !cnt.left&&flag.drug==5 && mv.track==0)
//                    flag.led=2;
	            led_control();
                flag.drug=0;
	            /*摄像头处理*/
